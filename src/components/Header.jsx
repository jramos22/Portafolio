            ...
            <div className='header_container'>
                ...
                <div className='header_menu'>
                    <nav className={`header_menu_nav ${clicked ? 'header_menu_nav--active': ''}`}>
                        ...
                        <a className='resume_button' href="https://drive.google.com/file/d/1G9Sc9qfX__8txxt4CJFPrfzvwbIO3sNF/view?usp=sharing">Resume</a>
                    </nav>
