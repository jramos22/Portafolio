...
export default function Projects() {
    ...
    useEffect(() => {
        ...
        const getProjects = async () => {
            ...
            const Body = 'query project{allProjects{projectCard{id cardImage{url filename} cardTitle cardDescription cardTechnology{id technologyName} cardLink}}}';
        ...
        const getPractices = async () => {
            const Url = process.env.REACT_APP_API_URL;
            const Token = process.env.REACT_APP_API_TOKEN;
            const Body = 'query practices{allPractices{practiceItem{id cardImage{url filename} cardTitle cardTechnology{id technologyName}}}}';
            const get = await CallApi(Url, Token, Body);
            setPractices(get);
        }
